...
export default function BVSearchbar({ className }: BVSearchbarProps) {
  return (
    <div
      className={`border-2 border-(--robe-dark) rounded-2xl w-[210px] h-[34px] bg-white z-10 flex flex-row items-center ${className}`}
    >
      <input type="text" className="w-4/5" />
      <div className="w-0 h-[22px] border-l-1 border-robe-dark mr-2" />
